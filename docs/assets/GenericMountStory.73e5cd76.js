...
const Comp3 = {"title":"Theme","icon":"carbon:color-palette","group":"configuration","docsOnly":true,"variants":[]};

const Comp4 = {"title":"Installation","icon":"carbon:arrow-shift-down","group":"introduction","docsOnly":true,"variants":[]};

const Comp5 = {"title":"Config","icon":"carbon:settings","group":"configuration","docsOnly":true,"variants":[]};

const Comp0 = defineAsyncComponent(() => __vitePreload(() => import('./Button.story.4323141e.js'),true?["assets/Button.story.4323141e.js","assets/vendor.4da1c531.js"]:void 0));
